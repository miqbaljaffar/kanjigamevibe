  ...
  return (
    ...
    >
      ...
      <div className="glass-card aspect-video relative flex flex-col items-center justify-center p-8 overflow-hidden">
        ...
        {/* PERBAIKAN 1: Tambahkan pointer-events-none agar tidak menutupi klik */}
        ...
        {/* PERBAIKAN 2: Tambahkan onClick, cursor-pointer, relative z-10 pada Icon Kamera */}
        <Camera 
          onClick={handleButtonClick}
          className="w-16 h-16 text-yellow-500 mb-4 opacity-50 cursor-pointer hover:opacity-100 transition-opacity relative z-10" 
        />
        
        {/* Tambahkan relative z-10 agar teks berada di atas overlay */}
        ...
        {/* PERBAIKAN 3: Tambahkan relative z-10 pada tombol utama */}
        <button 
          onClick={handleButtonClick}
          disabled={isScanning}
          className={cn(
            "cursor-pointer bg-yellow-500 text-black font-arcade px-8 py-3 rounded hover:bg-yellow-400 transition-all relative z-10",
